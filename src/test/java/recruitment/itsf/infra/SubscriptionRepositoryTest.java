...
import recruitment.itsf.infra.repository.SubscriptionRepository;
...
class SubscriptionRepositoryTest {
    ...
    void findAllSubscriptions_shouldReturnSubscriptionsWithOption() {
        ...
        assertEquals(OptionType.NETFLIX, lSubscriptionsEntityList.getFirst().getOptionsList().getFirst().getOptionType());
    }
